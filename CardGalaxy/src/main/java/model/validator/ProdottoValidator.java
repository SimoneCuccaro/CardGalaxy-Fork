...
public class ProdottoValidator {
    public static Validator validateProdotto(HttpServletRequest request) {
        ...
        requestValidator.assertMatch("piattaforma",Pattern.compile("^[\\s\\S]{2,20}$"),"piattaforma compresa fra 2 e 20 caratteri");
        requestValidator.assertMatch("descrizione",Pattern.compile("^[\\s\\S]{10,100}$"),"descrizione compresa fra 10 e 100 caratteri");
